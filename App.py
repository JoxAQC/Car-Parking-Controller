...
class App(customtkinter.CTk):
    def __init__(self):
        ...
        self.historial_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "expediente_blanco.png")),
                                                 dark_image=Image.open(os.path.join(image_path, "expediente_blanco.png")), size=(20, 20))
        self.add_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "agregar.png")),
                                                     dark_image=Image.open(os.path.join(image_path, "agregar.png")), size=(20, 20))
        self.manage_image = customtkinter.CTkImage(light_image=Image.open(os.path.join(image_path, "gestionar.png")),
